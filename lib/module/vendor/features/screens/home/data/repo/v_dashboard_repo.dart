...
class VDashboardRepo {
  static Future<Map<String, dynamic>> getDashboardDataF(
      BuildContext context) async {
    final state = context.read<AppAuthController>().state;
    if (state is AuthCubitAuthenticateState) {
      try {
        final url = Uri.parse('${VApiConst.baseUrl}${VApiConst.dashboard}');
        ...
        log('repo - catch error - vendor - DASHBOARD => ${e.toString()}F');
        return {};
      }
    } else {
      return {};
