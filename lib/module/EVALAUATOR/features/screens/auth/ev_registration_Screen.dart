...
class EvRegistrationScreen extends StatefulWidget {
  const EvRegistrationScreen({super.key});

  @override
  State<EvRegistrationScreen> createState() => _EvLoginScreenState();
}

class _EvLoginScreenState extends State<EvRegistrationScreen>
