...
class FetchUploadedVehiclePhotoRepo {
  static Future<Map<String, dynamic>> fetchVehilcePhoto(
    ...
    if (state is AuthCubitAuthenticateState) {
      try {
        final url = Uri.parse('${EvApiConst.baseUrl}${EvApiConst.fetchUploadedVehicle}');
