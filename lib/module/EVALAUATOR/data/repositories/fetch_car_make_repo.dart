...
class GetCarMakeRepo {
  static Future<Map<String, dynamic>> getCarMakeList(
      BuildContext context) async {
    final state = context.read<AppAuthController>().state;
    if (state is AuthCubitAuthenticateState) {
      try {
        final url = Uri.parse('${EvApiConst.baseUrl}${EvApiConst.fetchCarMake}');
        ...
        log('repo - catch error - fetch car make => ${e.toString()}   ');
        return {};
      }
    } else {
      return {};
