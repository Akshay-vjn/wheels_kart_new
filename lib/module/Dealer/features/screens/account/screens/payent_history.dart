    ...
    return Scaffold(
      ...
      body: Center(
        child: BlocBuilder<
          ...
          PaymentHistoryControllerState
        >(
          builder: (context, state) {
            switch (state) {
              case PaymentHistoryControllerSuccessState():
                {
              ...
              case PaymentHistoryControllerErrorState():
                {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, size: 16, color: dataColor ?? VColors.DARK_GREY),
          ),
          SizedBox(width: 12),
          Expanded(
            child: Column(
