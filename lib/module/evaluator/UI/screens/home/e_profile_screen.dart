...
class _EvProfileScreenState extends State<EvProfileScreen> {
                    ...
                    decoration: BoxDecoration(
                        boxShadow: [
                          BoxShadow(
                              ...
                              spreadRadius: 1,
                              color:
                                  AppColors.DEFAULT_BLUE_DARK.withOpacity(.1))
                        ],
                        color: AppColors.kWhite,
                        borderRadius:
  ...
  Widget _buildProfileTile(String title, IconData icon, void Function()? onTap,
      {bool? hideArrow, Color? textColor, Color? iconColor}) {
    return ListTile(
      onTap: onTap,
      leading: Icon(
        icon,
