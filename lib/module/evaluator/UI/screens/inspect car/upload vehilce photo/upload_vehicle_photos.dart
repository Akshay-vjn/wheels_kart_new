...
class _UploadVehiclePhotosState extends State<UploadVehiclePhotos>
  ...
  Widget _buildProgressIndicator(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppColors.DEFAULT_BLUE_DARK.withOpacity(0.1), Colors.white],
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                progress == 1.0 ? Colors.green : AppColors.DEFAULT_BLUE_DARK,
              ),
              minHeight: 8,
            ),
          ),
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, color: AppColors.DEFAULT_BLUE_DARK, size: 20),
        ),
  ...
  Widget _buildAngleSelector(
    ...
    return Wrap(
      ...
      spacing: 12,
      children:
          angleState.pictureAngles.asMap().entries.map((e) {
                          ...
                          colors:
                              isUploaded
                                  ...
                                  ? [
                                    ...
                                    AppColors.DEFAULT_ORANGE.withOpacity(0.8),
                                  ]
                                  : [
                                    AppColors.DEFAULT_BLUE_DARK,
                                    AppColors.DEFAULT_BLUE_DARK.withOpacity(
                                      0.8,
                                    ),
                                  ],
                        ),
