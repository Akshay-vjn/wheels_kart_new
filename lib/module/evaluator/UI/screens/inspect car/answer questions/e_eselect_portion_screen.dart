      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: progress == 1.0 ? AppColors.kGreen : AppColors.DEFAULT_BLUE_DARK,
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                progress == 1.0 ? AppColors.kGreen : AppColors.DEFAULT_BLUE_DARK,
              ),
              minHeight: 8,
            ),
          ),
          if (progress == 1.0) ...[
            ...
            Row(
              children: [
                Icon(Icons.check_circle, color: AppColors.kGreen, size: 16),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            portion.portionName,
                            style: AppStyle.style(
                              color: isCompleted ? AppColors.kGreen : null,
                              fontWeight: FontWeight.w600,
                              context: context,
                              size: AppDimensions.fontSize16(context),
                            ),
                          ...
                          Text(
                            ...
                            style: AppStyle.style(
                              color: isCompleted ? AppColors.kGreen : Colors.grey[600],
                              context: context,
                              size: AppDimensions.fontSize12(context),
                            ),
                          ),
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: AppStyle.style(
                            fontWeight: FontWeight.bold,
                            color: isCompleted ? AppColors.kGreen : AppColors.DEFAULT_BLUE_DARK,
                            context: context,
                ...
                if (!isCompleted && currentStatus.totalQuestions > 0) ...[
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      backgroundColor: Colors.grey[200],
                      valueColor: AlwaysStoppedAnimation<Color>(AppColors.DEFAULT_BLUE_DARK),
                      minHeight: 4,
                    ),
                  ),
                ],
