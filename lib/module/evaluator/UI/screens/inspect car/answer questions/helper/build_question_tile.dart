  ...
  Color _getBorderColor(SubmissionState state) {
    switch (state) {
      ...
      case SubmissionState.LOADING:
        return AppColors.DEFAULT_BLUE_DARK;
      default:
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          color: AppColors.DEFAULT_BLUE_DARK.withOpacity(0.05),
        ),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
  ...
  Widget _buildActionButton(SubmissionState currentstate, bool isLoading) {
    ...
    if (isCompleted) {
      return Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.cloud_done, color: AppColors.kGreen, size: 20),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor:
              hasError ? AppColors.kRed : AppColors.DEFAULT_BLUE_DARK,
