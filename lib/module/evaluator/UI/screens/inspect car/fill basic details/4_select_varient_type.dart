...
import 'package:wheels_kart/module/evaluator/data/model/varient_model.dart';
import 'package:wheels_kart/module/evaluator/data/repositories/fetch_car_varient_repo.dart';
...
class _EvSelectFuealTypeScreenState extends State<EvSelectFuealTypeScreen> {
  List<Map<String, dynamic>> listOFFuelType = [
    {'title': 'Petrol', 'img': ConstImages.petrolImage},
    {'title': 'Diesel', 'img': ConstImages.dieselImage},
    {'title': 'Petrol+CNG', 'img': ConstImages.petrolAndCngImage},
    {'title': 'Hybrid', 'img': ConstImages.hybridImae},
    {'title': 'Petrol+LPG', 'img': ConstImages.petrolAndLpgImage},
    {'title': 'CNG', 'img': ConstImages.cngImage},
    {'title': 'Electric', 'img': ConstImages.electricalImage},
  ];
  ...
  Color boxColor = AppColors.FILL_COLOR;
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Icon(Icons.edit, color: AppColors.DEFAULT_BLUE_GREY),
                  ),
                ),
              ],
            ),
