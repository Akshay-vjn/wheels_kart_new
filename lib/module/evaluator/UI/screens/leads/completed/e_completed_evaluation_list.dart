...
class _EvCompletedLeadTabState extends State<EvCompletedLeadTab>
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: isDownloading
              ...
              : [AppColors.DEFAULT_ORANGE, AppColors.DEFAULT_ORANGE.withOpacity(0.8)],
        ),
        boxShadow: [
          BoxShadow(
            color: (isDownloading ? Colors.grey : AppColors.DEFAULT_ORANGE).withOpacity(0.3),
            blurRadius: 8,
  ...
  Widget _buildStatusChip(String status) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppColors.kGreen, AppColors.kGreen.withOpacity(0.8)],
        ),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.DARK_SECONDARY.withOpacity(0.1),
